  ...
  return (
    <div className="h-[500px] relative p-4 flex flex-col gap-12 justify-center items-center">
      <Image
        ...
        width={1440}
        height={810}
        className="w-full h-full object-cover absolute -z-10 left-0 top-0 opacity-20"
        alt="tagline-bg"
      />
        <span className="block w-full h-full top-0 left-0 absolute -z-10 " style={{background: "radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 100%)"}}></span>
