...
export default function ProcessCard({icon: Icon, title, desc, step}:ProcessDataType) {
  return (
    <div
      className="bg-secondaryColor p-5 rounded-xl flex gap-6 justify-end items-center relative overflow-hidden border border-hairlineColor"
     
    >
      
      <div>
        <Icon className="text-8xl text-primaryColor opacity-60"/>
      </div>
