...
export const metadata: Metadata = {
  ...
  description: "Kalaa Iris is India's first photography studio, Discover the captivating beauty of your iris with Kalaa Iris. We combine art, science, and technology to transform the unique patterns of your eye into breathtaking works of art.",
