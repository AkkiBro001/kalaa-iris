...
export default function Blob_Details_Banner({blog_banner_image, title}:blog_data_type) {
    if(!blog_banner_image) return null
  return (
    <div className='h-[300px] overflow-hidden relative flex items-center justify-center'>
